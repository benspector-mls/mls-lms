...
/**
 * The matriculation itself: what it is, its courses, who instructs it, its lateness rule, and how
 * it is retired.
 *
 ...
 * matriculation in the same way its name and its lateness rule are. It had its own address while the
