...
**The codes for the fortnight print on one sheet.** **Print the coming codes**, beside that list, gives a page for the people who open the building before an instructor arrives: each coming day, its code, and the hours it works. It says to give out today's code only, and that replacing a code or removing a day makes that row wrong.
