...
| `npm run verify:modules`      | Creating, renaming, reordering, and removing a course's units, through the callers                                                                                                              |
...
| `npm run verify:enrollment`   | Starting a matriculation, its roster and join link, creating and copying courses, publishing one, and the removed-fellow pair — through the callers                                              |
| `npm run verify:programs`     | The instructor link, who is named on which course, ownership in pairs, and deleting a matriculation — through the callers                                                                        |
