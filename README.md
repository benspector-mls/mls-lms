...
| `npm run verify:attendance`   | Starting a session, the rotating code and its grace window, corrections, the backstop, ending and reopening — plus the two rules that live in Postgres rather than in a procedure                |
